...
這是一個基於 AI 的剩餘食材食譜推薦系統，幫助使用者將冰箱中的剩餘食材轉化為美味料理。系統結合了電腦視覺、RAG (檢索增強生成) 技術和現代 Web 開發技術。

## ✨ 主要功能

- **AI 食材識別**: 上傳照片自動識別食材種類和數量
- **RAG 智能推薦**: 基於檢索增強生成技術推薦客製化食譜
- **替代方案建議**: 針對缺少的食材提供替代建議
- **響應式設計**: 支援桌面、平板、手機等多種裝置
- **使用者回饋**: 收集使用者評價以優化推薦品質
...
2. **Python** 3.9+
3. **PostgreSQL** 12+
4. **Google Cloud API Key** (Vision API)
5. **OpenAI API Key**
